...
#define INTERNAL_CATCH_TEST( expr, resultDisposition, macroName )                                           \
    ...
    {                                                                                                       \
        ...
        false && ( expr ) ) )  // expr here is never evaluated at runtime but it forces the compiler to give it a look
    ...
    class CompositeGenerator
    {
       public:
        ...
        operator T( ) const
        {
            ...
            return T( );  // Suppress spurious "not all control paths return a value" warning in Visual Studio - if you
                          // know how to fix this please do so
        }
...
#pragma clang diagnostic pop
       ...
       public:
        ...
        bool matches( TestCaseInfo const& testCase ) const
        {
            ...
            for ( std::vector<Filter>::const_iterator it = m_filters.begin( ), itEnd = m_filters.end( ); it != itEnd;
                  ++it )
                if ( it->matches( testCase ) )
                    return true;
            return false;
...
namespace Catch
{
    ...
    inline Clara::CommandLine<ConfigData> makeCommandLineParser( )
    {
        ...
        cli["-f"]["--input-file"].describe( "load test names to run from a file" ).bind( &loadTestNamesFromFile,
                                                                                         "filename" );
    ...
    namespace SectionTracking
    {
        ...
        class TrackedSection
        {
           ...
           public:
            ...
            void leave( )
            {
                for ( TrackedSections::const_iterator it = m_children.begin( ), itEnd = m_children.end( ); it != itEnd;
                      ++it )
        ...
        class TestCaseTracker
        {
           public:
            TestCaseTracker( std::string const& testCaseName )
                : m_testCase( testCaseName, NULL ), m_currentSection( &m_testCase ), m_completedASectionThisRun( false )
            {
            }
...
namespace Catch
{
    ...
    class Runner
    {
       ...
       public:
        ...
        Totals runTests( )
        {
            ...
            for ( std::vector<TestCase>::const_iterator it = testCases.begin( ), itEnd = testCases.end( ); it != itEnd;
                  ++it )
            {
                testsRunForGroup++;
    ...
    class Session : NonCopyable
    {
       ...
       public:
        ...
        {
            Catch::cout( ) << "\nCatch v" << libraryVersion.majorVersion << "." << libraryVersion.minorVersion
                           << " build " << libraryVersion.buildNumber;
...
namespace Catch
{
    ...
    Stream::Stream( std::streambuf* _streamBuf, bool _isOwned ) : streamBuf( _streamBuf ), isOwned( _isOwned )
    {
    }
    ...
    struct ConsoleReporter : StreamingReporterBase
    {
       ...
       private:
        ...
        void lazyPrintRunInfo( )
        {
            ...
            stream << currentTestRunInfo->name << " is a Catch v" << libraryVersion.majorVersion << "."
                   << libraryVersion.minorVersion << " b" << libraryVersion.buildNumber;
            if ( libraryVersion.branchName != std::string( "master" ) )
...
#define CATCH_REQUIRE_FALSE( expr ) \
    INTERNAL_CATCH_TEST(            \
        expr, Catch::ResultDisposition::Normal | Catch::ResultDisposition::FalseTest, "CATCH_REQUIRE_FALSE" )
...
#define CATCH_CHECK_FALSE( expr ) \
    INTERNAL_CATCH_TEST(          \
        expr, Catch::ResultDisposition::ContinueOnFailure | Catch::ResultDisposition::FalseTest, "CATCH_CHECK_FALSE" )
...
#define CATCH_SUCCEED( ... ) \
    INTERNAL_CATCH_MSG(      \
        Catch::ResultWas::Ok, Catch::ResultDisposition::ContinueOnFailure, "CATCH_SUCCEED", __VA_ARGS__ )
#else
...
#define REQUIRE_FALSE( expr )                                                                                     \
    INTERNAL_CATCH_TEST( expr, Catch::ResultDisposition::Normal | Catch::ResultDisposition::FalseTest, "REQUIRE_" \
                                                                                                       "FALSE" )
...
#define CHECK_FALSE( expr ) \
    INTERNAL_CATCH_TEST(    \
        expr, Catch::ResultDisposition::ContinueOnFailure | Catch::ResultDisposition::FalseTest, "CHECK_FALSE" )
#define CHECKED_IF( expr ) INTERNAL_CATCH_IF( expr, Catch::ResultDisposition::ContinueOnFailure, "CHECKED_IF" )
#define CHECKED_ELSE( expr ) INTERNAL_CATCH_ELSE( expr, Catch::ResultDisposition::ContinueOnFailure, "CHECKED_ELSE" )
#define CHECK_NOFAIL( expr ) \
    INTERNAL_CATCH_TEST(     \
        expr, Catch::ResultDisposition::ContinueOnFailure | Catch::ResultDisposition::SuppressFail, "CHECK_NOFAIL" )
...
#define FAIL( msg ) \
    INTERNAL_CATCH_MSG( Catch::ResultWas::ExplicitFailure, Catch::ResultDisposition::Normal, "FAIL", msg )
#define SUCCEED( msg ) \
