...
#define ASIO_PRIVATE_CTR_DEF( n )                                                                                \
    ...
    explicit basic_socket_iostream( ASIO_VARIADIC_PARAMS( n ) )                                                  \
        : std::basic_iostream<char>( &this->detail::socket_iostream_base<Protocol, StreamSocketService, Time,    \
                                                                         TimeTraits, TimerService>::streambuf_ ) \
    {                                                                                                            \
...
namespace asio
{
    ...
    class basic_socket_iostream
        : private detail::socket_iostream_base<Protocol, StreamSocketService, Time, TimeTraits, TimerService>,
          public std::basic_iostream<char>
    {
       ...
       public:
        ...
        basic_socket_iostream( )
            : std::basic_iostream<char>(
                  &this->detail::socket_iostream_base<Protocol, StreamSocketService, Time, TimeTraits, TimerService>::
                       streambuf_ )
        {
            this->setf( std::ios_base::unitbuf );
        }
        ...
        {
            return const_cast<basic_socket_streambuf<Protocol, StreamSocketService, Time, TimeTraits, TimerService>*>(
                &this->detail::socket_iostream_base<Protocol, StreamSocketService, Time, TimeTraits,
                                                    TimerService>::streambuf_ );
        }
