...
namespace asio
{
    ...
    class basic_deadline_timer : public basic_io_object<TimerService>
    {
       public:
         ...
         */
        explicit basic_deadline_timer( asio::io_service& io_service ) : basic_io_object<TimerService>( io_service )
        {
        }
        ...
        {
            asio::error_code ec;
            std::size_t s = this->service.expires_at( this->implementation, expiry_time, ec );
            asio::detail::throw_error( ec, "expires_at" );
            return s;
        }
        ...
        {
            asio::error_code ec;
            std::size_t s = this->service.expires_from_now( this->implementation, expiry_time, ec );
            asio::detail::throw_error( ec, "expires_from_now" );
            return s;
        }
        ...
        {
            return this->service.expires_from_now( this->implementation, expiry_time, ec );
        }
        ...
        async_wait( ASIO_MOVE_ARG( WaitHandler ) handler )
        {
            ...
            return this->service.async_wait( this->implementation, ASIO_MOVE_CAST( WaitHandler )( handler ) );
        }
    };
