...
#endif
    {
       ...
       public:
        ...
        explicit signal_set_service( asio::io_service& io_service )
            : asio::detail::service_base<signal_set_service>( io_service ), service_impl_( io_service )
        {
        }
        ...
        async_wait( implementation_type& impl, ASIO_MOVE_ARG( SignalHandler ) handler )
        {
            detail::async_result_init<SignalHandler, void( asio::error_code, int )> init(
