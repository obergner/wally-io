...
namespace asio
{
    ...
    class basic_socket : public basic_io_object<SocketService>, public socket_base
    {
       public:
         ...
         */
        explicit basic_socket( asio::io_service& io_service ) : basic_io_object<SocketService>( io_service )
        {
        }
        ...
        {
            asio::error_code ec;
            this->get_service( ).assign( this->get_implementation( ), protocol, native_socket, ec );
         ...
         */
        basic_socket( basic_socket&& other ) : basic_io_object<SocketService>( ASIO_MOVE_CAST( basic_socket )( other ) )
        {
        }
        ...
        {
            basic_io_object<SocketService>::operator=( ASIO_MOVE_CAST( basic_socket )( other ) );
            return *this;
        }
         ...
         */
        template <typename Protocol1, typename SocketService1>
        typename enable_if<is_convertible<Protocol1, Protocol>::value, basic_socket>::type& operator=(
            basic_socket<Protocol1, SocketService1>&& other )
        {
            basic_socket tmp( ASIO_MOVE_CAST2( basic_socket<Protocol1, SocketService1> )( other ) );
            basic_io_object<SocketService>::operator=( ASIO_MOVE_CAST( basic_socket )( tmp ) );
            return *this;
        }
        ...
        asio::error_code assign( const protocol_type& protocol,
                                 ...
                                 asio::error_code& ec )
        {
            return this->get_service( ).assign( this->get_implementation( ), protocol, native_socket, ec );
        }
    ...
    !defined( ASIO_ENABLE_CANCELIO )
        ...
        void connect( const endpoint_type& peer_endpoint )
        {
            ...
            if ( !is_open( ) )
            {
                this->get_service( ).open( this->get_implementation( ), peer_endpoint.protocol( ), ec );
        ...
        asio::error_code connect( const endpoint_type& peer_endpoint, asio::error_code& ec )
        {
            if ( !is_open( ) )
            {
                if ( this->get_service( ).open( this->get_implementation( ), peer_endpoint.protocol( ), ec ) )
                {
                    return ec;
                }
            }

            return this->get_service( ).connect( this->get_implementation( ), peer_endpoint, ec );
        }
        ...
        async_connect( const endpoint_type& peer_endpoint, ASIO_MOVE_ARG( ConnectHandler ) handler )
        {
            ...
            if ( !is_open( ) )
            {
                ...
                if ( this->get_service( ).open( this->get_implementation( ), protocol, ec ) )
                {
                    ...
                    this->get_io_service( ).post( asio::detail::bind_handler(
                        ASIO_MOVE_CAST( ASIO_HANDLER_TYPE( ConnectHandler, void( asio::error_code ) ) )( init.handler ),
                        ec ) );
            ...
            return this->get_service( ).async_connect( this->get_implementation( ), peer_endpoint,
                                                       ASIO_MOVE_CAST( ConnectHandler )( handler ) );
        }
        ...
        {
            return this->get_service( ).get_option( this->get_implementation( ), option, ec );
        }
        ...
        {
            return this->get_service( ).io_control( this->get_implementation( ), command, ec );
        }
        ...
        {
            return this->get_service( ).non_blocking( this->get_implementation( ), mode, ec );
        }
        ...
        {
            asio::error_code ec;
            this->get_service( ).native_non_blocking( this->get_implementation( ), mode, ec );
        ...
        {
            return this->get_service( ).native_non_blocking( this->get_implementation( ), mode, ec );
        }
        ...
        {
            asio::error_code ec;
            endpoint_type ep = this->get_service( ).remote_endpoint( this->get_implementation( ), ec );
