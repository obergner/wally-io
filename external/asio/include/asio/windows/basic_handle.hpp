...
#include "asio/detail/config.hpp"
    ...
    defined( ASIO_HAS_WINDOWS_OBJECT_HANDLE ) || defined( GENERATING_DOCUMENTATION )
    ...
    namespace windows
    {
        ...
        class basic_handle : public basic_io_object<HandleService>
        {
           public:
             ...
             */
            explicit basic_handle( asio::io_service& io_service ) : basic_io_object<HandleService>( io_service )
            {
            }
             ...
             */
            basic_handle( asio::io_service& io_service, const native_handle_type& handle )
            ...
            basic_handle( basic_handle&& other )
                : basic_io_object<HandleService>( ASIO_MOVE_CAST( basic_handle )( other ) )
            {
            }
            ...
            {
                basic_io_object<HandleService>::operator=( ASIO_MOVE_CAST( basic_handle )( other ) );
                return *this;
            }
             ...
             */
            asio::error_code assign( const native_handle_type& handle, asio::error_code& ec )
            {
