...
namespace asio
{
    namespace windows
    {
        ...
        class basic_random_access_handle : public basic_handle<RandomAccessHandleService>
        {
           public:
            ...
            typedef typename RandomAccessHandleService::native_handle_type native_handle_type;
             ...
             */
            basic_random_access_handle( asio::io_service& io_service, const native_handle_type& handle )
            ...
            basic_random_access_handle( basic_random_access_handle&& other )
                : basic_handle<RandomAccessHandleService>( ASIO_MOVE_CAST( basic_random_access_handle )( other ) )
            {
            }
            ...
            {
                asio::error_code ec;
                std::size_t s = this->get_service( ).write_some_at( this->get_implementation( ), offset, buffers, ec );
            ...
            {
                return this->get_service( ).write_some_at( this->get_implementation( ), offset, buffers, ec );
            }
                                 ...
                                 ASIO_MOVE_ARG( WriteHandler ) handler )
            {
                ...
                return this->get_service( ).async_write_some_at( this->get_implementation( ), offset, buffers,
            ...
            {
                asio::error_code ec;
                std::size_t s = this->get_service( ).read_some_at( this->get_implementation( ), offset, buffers, ec );
            ...
            {
                return this->get_service( ).read_some_at( this->get_implementation( ), offset, buffers, ec );
            }
                                ...
                                ASIO_MOVE_ARG( ReadHandler ) handler )
            {
                ...
                return this->get_service( ).async_read_some_at( this->get_implementation( ), offset, buffers,
