    ...
    namespace windows
    {
        ...
        class basic_stream_handle : public basic_handle<StreamHandleService>
        {
           public:
             ...
             */
            basic_stream_handle( asio::io_service& io_service, const native_handle_type& handle )
            ...
            basic_stream_handle( basic_stream_handle&& other )
                : basic_handle<StreamHandleService>( ASIO_MOVE_CAST( basic_stream_handle )( other ) )
            {
            }
            ...
            {
                basic_handle<StreamHandleService>::operator=( ASIO_MOVE_CAST( basic_stream_handle )( other ) );
                return *this;
            }
