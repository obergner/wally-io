...
namespace asio
{
    ...
    std::size_t read_until( SyncReadStream& s, asio::basic_streambuf<Allocator>& b, char delim, asio::error_code& ec )
    {
        ...
        for ( ;; )
        {
            ...
            typedef typename asio::basic_streambuf<Allocator>::const_buffers_type const_buffers_type;
    ...
    template <typename SyncReadStream, typename Allocator>
    inline std::size_t read_until( SyncReadStream& s, asio::basic_streambuf<Allocator>& b, const std::string& delim )
    {
        asio::error_code ec;
        std::size_t bytes_transferred = read_until( s, b, delim, ec );
        asio::detail::throw_error( ec, "read_until" );
    ...
    template <typename SyncReadStream, typename Allocator>
    inline std::size_t read_until( SyncReadStream& s, asio::basic_streambuf<Allocator>& b, const boost::regex& expr )
    {
        asio::error_code ec;
                            ...
                            asio::error_code& ec )
    {
        ...
        for ( ;; )
        {
            ...
            boost::match_results<iterator, typename std::vector<boost::sub_match<iterator>>::allocator_type>
                match_results;
            if ( regex_search( start_pos, end, match_results, expr, boost::match_default | boost::match_partial ) )
            {
    ...
    namespace detail
    {
                        ...
                        {
                            {
                                // Determine the range of the data to be searched.
                                typedef
                                    typename asio::basic_streambuf<Allocator>::const_buffers_type const_buffers_type;
                                typedef asio::buffers_iterator<const_buffers_type> iterator;
        ...
        inline void* asio_handler_allocate( std::size_t size,
                                            read_until_delim_op<AsyncReadStream, Allocator, ReadHandler>* this_handler )
        {
                      ...
                      ASIO_MOVE_ARG( ReadHandler ) handler )
    {
        ...
        detail::read_until_delim_op<AsyncReadStream, Allocator,
            ...
            s, b, delim, init.handler )( asio::error_code( ), 0, 1 );
    ...
    namespace detail
    {
        ...
        inline void* asio_handler_allocate(
            std::size_t size,
            read_until_delim_string_op<AsyncReadStream, Allocator, ReadHandler>* this_handler )
        {
            return asio_handler_alloc_helpers::allocate( size, this_handler->handler_ );
        }
    ...
    namespace detail
    {
        template <typename AsyncReadStream, typename Allocator, typename RegEx, typename ReadHandler>
        ...
        template <typename Function, typename AsyncReadStream, typename Allocator, typename RegEx, typename ReadHandler>
        inline void asio_handler_invoke(
            Function& function,
            read_until_expr_op<AsyncReadStream, Allocator, RegEx, ReadHandler>* this_handler )
        {
                      ...
                      ASIO_MOVE_ARG( ReadHandler ) handler )
    {
        ...
        detail::read_until_expr_op<AsyncReadStream, Allocator, boost::regex,
                                   ASIO_HANDLER_TYPE( ReadHandler, void( asio::error_code, std::size_t ) )>(
            s, b, expr, init.handler )( asio::error_code( ), 0, 1 );
    ...
    namespace detail
    {
        ...
        inline void* asio_handler_allocate(
            std::size_t size,
            read_until_match_op<AsyncReadStream, Allocator, MatchCondition, ReadHandler>* this_handler )
        {
            return asio_handler_alloc_helpers::allocate( size, this_handler->handler_ );
        }
                      ...
                      typename enable_if<is_match_condition<MatchCondition>::value>::type* )
    {
        ...
        detail::read_until_match_op<AsyncReadStream, Allocator, MatchCondition,
                                    ASIO_HANDLER_TYPE( ReadHandler, void( asio::error_code, std::size_t ) )>(
            s, b, match_condition, init.handler )( asio::error_code( ), 0, 1 );
