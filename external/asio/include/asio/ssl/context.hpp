    ...
    namespace ssl
    {
        ...
        class context : public context_base, private noncopyable
        {
           public:
             ...
             * @note Calls @c SSL_CTX_use_certificate or SSL_CTX_use_certificate_ASN1.
             */
            ASIO_DECL asio::error_code use_certificate( const const_buffer& certificate,
                                                        file_format format,
                                                        asio::error_code& ec );
             ...
             * @note Calls @c SSL_CTX_use_certificate_file.
             */
            ASIO_DECL asio::error_code use_certificate_file( const std::string& filename,
                                                             file_format format,
                                                             asio::error_code& ec );
             ...
             * @note Calls @c SSL_CTX_use_PrivateKey or SSL_CTX_use_PrivateKey_ASN1.
             */
            ASIO_DECL asio::error_code use_private_key( const const_buffer& private_key,
                                                        file_format format,
                                                        asio::error_code& ec );
             ...
             * @note Calls @c SSL_CTX_use_PrivateKey_file.
             */
            ASIO_DECL asio::error_code use_private_key_file( const std::string& filename,
                                                             file_format format,
                                                             asio::error_code& ec );
             ...
             * @note Calls @c SSL_CTX_use_RSAPrivateKey or SSL_CTX_use_RSAPrivateKey_ASN1.
             */
            ASIO_DECL asio::error_code use_rsa_private_key( const const_buffer& private_key,
                                                            file_format format,
                                                            asio::error_code& ec );
             ...
             * @note Calls @c SSL_CTX_use_RSAPrivateKey_file.
             */
            ASIO_DECL asio::error_code use_rsa_private_key_file( const std::string& filename,
                                                                 file_format format,
                                                                 asio::error_code& ec );
           ...
           private:
            ...
            ASIO_DECL asio::error_code do_set_verify_callback( detail::verify_callback_base* callback,
                                                               asio::error_code& ec );
            ...
            ASIO_DECL asio::error_code do_set_password_callback( detail::password_callback_base* callback,
                                                                 asio::error_code& ec );
