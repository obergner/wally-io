...
namespace asio
{
    namespace ssl
    {
        namespace detail
        {
            ...
            asio::error_code engine::set_verify_callback( verify_callback_base* callback, asio::error_code& ec )
            {
                if ( SSL_get_app_data( ssl_ ) )
                    delete static_cast<verify_callback_base*>( SSL_get_app_data( ssl_ ) );
                ...
                ::SSL_set_verify( ssl_, ::SSL_get_verify_mode( ssl_ ), &engine::verify_callback_function );
            ...
            {
                return perform( ( type == asio::ssl::stream_base::client ) ? &engine::do_connect : &engine::do_accept,
                                0, 0, ec, 0 );
            }
                                        ...
                                        std::size_t& bytes_transferred )
            {
                ...
                return perform( &engine::do_write, const_cast<void*>( asio::buffer_cast<const void*>( data ) ),
                                       ...
                                       std::size_t& bytes_transferred )
            {
                ...
                return perform( &engine::do_read, asio::buffer_cast<void*>( data ), asio::buffer_size( data ), ec,
                                &bytes_transferred );
            }

            asio::mutable_buffers_1 engine::get_output( const asio::mutable_buffer& data )
            {
                int length = ::BIO_read( ext_bio_, asio::buffer_cast<void*>( data ),
            ...
            {
                int length = ::BIO_write( ext_bio_, asio::buffer_cast<const void*>( data ),
                                          static_cast<int>( asio::buffer_size( data ) ) );
