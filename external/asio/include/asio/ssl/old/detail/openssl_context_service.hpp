    ...
    namespace ssl
    {
        namespace old
        {
            namespace detail
            {
                ...
                class openssl_context_service : public asio::detail::service_base<openssl_context_service>
                {
                   public:
                    ...
                    typedef boost::function<std::string( std::size_t, context_base::password_purpose )>
                    ...
                    static int password_callback( char* buf, int size, int purpose, void* data )
                    {
                        ...
                        if ( data )
                        {
                            password_callback_type* callback = static_cast<password_callback_type*>( data );
                            std::string passwd =
                                ( *callback )( static_cast<std::size_t>( size ),
                                                            ...
                                                            asio::error_code& ec )
                    {
                        ...
                        {
                            password_callback_type* callback_function = new password_callback_type( callback );
                            impl->default_passwd_callback_userdata = callback_function;
                        }

                        // Set the password callback.
                        SSL_CTX_set_default_passwd_cb( impl, &openssl_context_service::password_callback );
