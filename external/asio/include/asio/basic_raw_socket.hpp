    ...
    class basic_raw_socket : public basic_socket<Protocol, RawSocketService>
    {
       public:
        ...
        basic_raw_socket( asio::io_service& io_service,
            ...
            : basic_socket<Protocol, RawSocketService>( io_service, protocol, native_socket )
        {
        }
        ...
        basic_raw_socket( basic_raw_socket&& other )
            : basic_socket<Protocol, RawSocketService>( ASIO_MOVE_CAST( basic_raw_socket )( other ) )
        {
        }
        ...
        {
            basic_socket<Protocol, RawSocketService>::operator=( ASIO_MOVE_CAST( basic_raw_socket )( other ) );
            return *this;
        }
