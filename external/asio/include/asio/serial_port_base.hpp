       ...
       public:
        ...
        class baud_rate
        {
           public:
            ...
            ASIO_DECL asio::error_code store( ASIO_OPTION_STORAGE& storage, asio::error_code& ec ) const;
            ASIO_DECL asio::error_code load( const ASIO_OPTION_STORAGE& storage, asio::error_code& ec );
