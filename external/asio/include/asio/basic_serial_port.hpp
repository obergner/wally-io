...
namespace asio
{
    ...
    class basic_serial_port : public basic_io_object<SerialPortService>, public serial_port_base
    {
       public:
         ...
         */
        explicit basic_serial_port( asio::io_service& io_service ) : basic_io_object<SerialPortService>( io_service )
        {
        }
         ...
         * port.
         */
        explicit basic_serial_port( asio::io_service& io_service, const std::string& device )
            : basic_io_object<SerialPortService>( io_service )
        {
            asio::error_code ec;
            this->get_service( ).open( this->get_implementation( ), device, ec );
         ...
         */
        basic_serial_port( asio::io_service& io_service, const native_handle_type& native_serial_port )
            : basic_io_object<SerialPortService>( io_service )
        {
            asio::error_code ec;
            this->get_service( ).assign( this->get_implementation( ), native_serial_port, ec );
        ...
        basic_serial_port( basic_serial_port&& other )
            : basic_io_object<SerialPortService>( ASIO_MOVE_CAST( basic_serial_port )( other ) )
        {
        }
        ...
        {
            basic_io_object<SerialPortService>::operator=( ASIO_MOVE_CAST( basic_serial_port )( other ) );
            return *this;
        }
         ...
         */
        asio::error_code assign( const native_handle_type& native_serial_port, asio::error_code& ec )
        {
            return this->get_service( ).assign( this->get_implementation( ), native_serial_port, ec );
        }
         ...
         */
        template <typename SettableSerialPortOption>
        asio::error_code set_option( const SettableSerialPortOption& option, asio::error_code& ec )
        {
         ...
         */
        template <typename GettableSerialPortOption>
        asio::error_code get_option( GettableSerialPortOption& option, asio::error_code& ec )
        {
        ...
        {
            asio::error_code ec;
            std::size_t s = this->get_service( ).write_some( this->get_implementation( ), buffers, ec );
        ...
        async_write_some( const ConstBufferSequence& buffers, ASIO_MOVE_ARG( WriteHandler ) handler )
        {
            ...
            return this->get_service( ).async_write_some( this->get_implementation( ), buffers,
        ...
        {
            asio::error_code ec;
            std::size_t s = this->get_service( ).read_some( this->get_implementation( ), buffers, ec );
        ...
        async_read_some( const MutableBufferSequence& buffers, ASIO_MOVE_ARG( ReadHandler ) handler )
        {
            ...
            return this->get_service( ).async_read_some( this->get_implementation( ), buffers,
