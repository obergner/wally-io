...
namespace asio
{
    namespace detail
    {
        ...
        class win_iocp_io_service : public asio::detail::service_base<win_iocp_io_service>
        {
           public:
            // Constructor. Specifies a concurrency hint that is passed through to the
            // underlying I/O completion port.
            ASIO_DECL win_iocp_io_service( asio::io_service& io_service, size_t concurrency_hint = 0 );
           ...
           private:
            ...
            typedef call_stack<win_iocp_io_service, win_iocp_thread_info> thread_call_stack;
        };
