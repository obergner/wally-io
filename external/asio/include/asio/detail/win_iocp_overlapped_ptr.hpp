    ...
    namespace detail
    {
        ...
        class win_iocp_overlapped_ptr : private noncopyable
        {
           public:
            ...
            explicit win_iocp_overlapped_ptr( asio::io_service& io_service, ASIO_MOVE_ARG( Handler ) handler )
            ...
            void reset( asio::io_service& io_service, Handler handler )
            {
                ...
                ASIO_HANDLER_CREATION( ( p.p, "io_service", &io_service.impl_, "overlapped" ) );
