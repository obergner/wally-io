        ...
        class reactive_socket_service_base
        {
           public:
                             ...
                             Handler& handler )
            {
                ...
                ASIO_HANDLER_CREATION( ( p.p, "socket", &impl, "async_send(null_buffers)" ) );
                                ...
                                Handler& handler )
            {
                ...
                start_op(
                    impl, ( flags & socket_base::message_out_of_band ) ? reactor::except_op : reactor::read_op, p.p,
                                ...
                                Handler& handler )
            {
                ...
                ASIO_HANDLER_CREATION( ( p.p, "socket", &impl, "async_receive(null_buffers)" ) );

                start_op( impl, ( flags & socket_base::message_out_of_band ) ? reactor::except_op : reactor::read_op,
                                       ...
                                       asio::error_code& ec )
            {
                ...
                return socket_ops::sync_recvmsg( impl.socket_, impl.state_, bufs.buffers( ), bufs.count( ), in_flags,
                                                 out_flags, ec );
            }
                                           ...
                                           Handler& handler )
            {
                ...
                ASIO_HANDLER_CREATION( ( p.p, "socket", &impl, "async_receive_with_flags" ) );

                start_op( impl, ( in_flags & socket_base::message_out_of_band ) ? reactor::except_op : reactor::read_op,
                                           ...
                                           Handler& handler )
            {
                ...
                ASIO_HANDLER_CREATION( ( p.p, "socket", &impl, "async_receive_with_flags(null_buffers)" ) );
