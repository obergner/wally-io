...
namespace asio
{
    namespace detail
    {
        ...
        {
            static signal_state state = {ASIO_STATIC_MUTEX_INIT, -1, -1, false, 0, {0}};
            return &state;
        }
        ...
        //   || defined(__CYGWIN__)
            ...
            signed_size_type result = ::write( state->write_descriptor_, &signal_number, sizeof( signal_number ) );
            (void)result;
            errno = saved_errno;
        ...
        {
           public:
            pipe_read_op( ) : reactor_op( &pipe_read_op::do_perform, pipe_read_op::do_complete )
            {
            }
        ...
        signal_set_service::signal_set_service( asio::io_service& io_service )
        ...
        void signal_set_service::fork_service( asio::io_service::fork_event fork_ev )
        {
#if !defined( ASIO_WINDOWS ) && !defined( ASIO_WINDOWS_RUNTIME ) && !defined( __CYGWIN__ )
            signal_state* state = get_signal_state( );
            ...
            switch ( fork_ev )
            {
                ...
                case asio::io_service::fork_parent:
                    if ( state->fork_prepared_ )
                    {
                        ...
                        lock.unlock( );
                        reactor_.register_internal_descriptor( reactor::read_op, read_descriptor, reactor_data_,
                                                               new pipe_read_op );
                    }
                    break;
        ...
        void signal_set_service::construct( signal_set_service::implementation_type& impl )
        {
            impl.signals_ = 0;
        }

        void signal_set_service::destroy( signal_set_service::implementation_type& impl )
        {
        ...
        asio::error_code signal_set_service::add( signal_set_service::implementation_type& impl,
                                                  int signal_number,
                                                  asio::error_code& ec )
        {
        ...
        asio::error_code signal_set_service::remove( signal_set_service::implementation_type& impl,
                                                     int signal_number,
                                                     asio::error_code& ec )
        {
            // Check that the signal number is valid.
        ...
        asio::error_code signal_set_service::clear( signal_set_service::implementation_type& impl,
                                                    asio::error_code& ec )
        {
            signal_state* state = get_signal_state( );
            static_mutex::scoped_lock lock( state->mutex_ );
        ...
        asio::error_code signal_set_service::cancel( signal_set_service::implementation_type& impl,
                                                     asio::error_code& ec )
        {
        ...
        void signal_set_service::add_service( signal_set_service* service )
        {
            ...
            int read_descriptor = state->read_descriptor_;
            lock.unlock( );
            service->reactor_.register_internal_descriptor( reactor::read_op, read_descriptor, service->reactor_data_,
                                                            new pipe_read_op );
#endif  // !defined(ASIO_WINDOWS)
        //   && !defined(ASIO_WINDOWS_RUNTIME)
        //   && !defined(__CYGWIN__)
        ...
        void signal_set_service::remove_service( signal_set_service* service )
        {
            ...
            if ( service->next_ || service->prev_ || state->service_list_ == service )
            {
                ...
                int read_descriptor = state->read_descriptor_;
                lock.unlock( );
                service->reactor_.deregister_descriptor( read_descriptor, service->reactor_data_, false );
                lock.lock( );
#endif  // !defined(ASIO_WINDOWS)
        //   && !defined(ASIO_WINDOWS_RUNTIME)
        //   && !defined(__CYGWIN__)
        ...
        void signal_set_service::start_wait_op( signal_set_service::implementation_type& impl, signal_op* op )
        {
