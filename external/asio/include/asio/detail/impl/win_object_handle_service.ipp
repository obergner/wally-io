...
namespace asio
{
    namespace detail
    {
        ...
        win_object_handle_service::win_object_handle_service( asio::io_service& io_service )
        ...
        void win_object_handle_service::construct( win_object_handle_service::implementation_type& impl )
        {
        ...
        void win_object_handle_service::move_construct( win_object_handle_service::implementation_type& impl,
        ...
        void win_object_handle_service::move_assign( win_object_handle_service::implementation_type& impl,
        ...
        void win_object_handle_service::destroy( win_object_handle_service::implementation_type& impl )
        {
            mutex::scoped_lock lock( mutex_ );
        ...
        asio::error_code win_object_handle_service::assign( win_object_handle_service::implementation_type& impl,
        ...
        asio::error_code win_object_handle_service::close( win_object_handle_service::implementation_type& impl,
                                                           asio::error_code& ec )
        {
            if ( is_open( impl ) )
            {
        ...
        asio::error_code win_object_handle_service::cancel( win_object_handle_service::implementation_type& impl,
                                                            asio::error_code& ec )
        {
            if ( is_open( impl ) )
            {
        ...
        void win_object_handle_service::start_wait_op( win_object_handle_service::implementation_type& impl,
                                                       wait_op* op )
        {
        ...
        void win_object_handle_service::register_wait_callback( win_object_handle_service::implementation_type& impl,
                                                                mutex::scoped_lock& lock )
        {
            lock.lock( );

            if ( !RegisterWaitForSingleObject( &impl.wait_handle_, impl.handle_,
                                               &win_object_handle_service::wait_callback, &impl, INFINITE,
                                               WT_EXECUTEONLYONCE ) )
            {
                DWORD last_error = ::GetLastError( );
