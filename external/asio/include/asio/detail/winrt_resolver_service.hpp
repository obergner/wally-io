           ...
           public:
            ...
            iterator_type resolve( implementation_type&, const query_type& query, asio::error_code& ec )
            {
                try
                {
                    ...
                    return iterator_type::create( endpoint_pairs, query.hints( ), query.host_name( ),
                                                  query.service_name( ) );
                }
            ...
            void async_resolve( implementation_type&, const query_type& query, Handler& handler )
            {
            ...
            iterator_type resolve( implementation_type&, const endpoint_type&, asio::error_code& ec )
            {
            ...
            void async_resolve( implementation_type&, const endpoint_type&, Handler& handler )
            {
                ...
                io_service_.get_io_service( ).post( detail::bind_handler( handler, ec, iterator ) );
            }
