...
namespace asio
{
    namespace detail
    {
        namespace socket_ops
        {
            ...
            ASIO_DECL signed_size_type
            send( socket_type s, const buf* bufs, size_t count, int flags, asio::error_code& ec );
            ...
            ASIO_DECL int poll_read( socket_type s, state_type state, asio::error_code& ec );

            ASIO_DECL int poll_write( socket_type s, state_type state, asio::error_code& ec );
