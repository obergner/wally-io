           ...
           public:
                                     ...
                                     std::size_t /*bytes_transferred*/ )
            {
                ...
                else
                {
                    ...
                    detail::binder2<Handler, asio::error_code, iterator_type> handler( o->handler_, o->ec_,
                                                                                       iterator_type( ) );
                    p.h = asio::detail::addressof( handler.handler_ );
                    if ( o->addrinfo_ )
                    {
                        handler.arg2_ =
                            iterator_type::create( o->addrinfo_, o->query_.host_name( ), o->query_.service_name( ) );
                    }
                    p.reset( );
