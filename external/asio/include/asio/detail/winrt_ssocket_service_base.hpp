    ...
    namespace detail
    {
        ...
        class winrt_ssocket_service_base
        {
           public:
            ...
            // Constructor.
            ASIO_DECL winrt_ssocket_service_base( asio::io_service& io_service );
            ...
            asio::error_code shutdown( base_implementation_type&, socket_base::shutdown_type, asio::error_code& ec )
            {
                ec = asio::error::operation_not_supported;
                return ec;
            }
                             ...
                             Handler& handler )
            {
                ...
                start_send_op( impl, buffer_sequence_adapter<asio::const_buffer, ConstBufferSequence>::first( buffers ),
                             ...
                             Handler& handler )
            {
                ...
                io_service_.get_io_service( ).post( detail::bind_handler( handler, ec, bytes_transferred ) );
            }
            ...
            {
                return do_receive(
                    impl, buffer_sequence_adapter<asio::mutable_buffer, MutableBufferSequence>::first( buffers ), flags,
                    ec );
            }
