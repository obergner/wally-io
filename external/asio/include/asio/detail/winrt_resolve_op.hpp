           ...
           public:
            ...
            static void do_complete( io_service_impl* owner, operation* base, const asio::error_code&, std::size_t )
            {
                ...
                if ( !o->ec_ )
                {
                    try
                    {
                        iterator = iterator_type::create( o->result_, o->query_.hints( ), o->query_.host_name( ),
                ...
                detail::binder2<Handler, asio::error_code, iterator_type> handler( o->handler_, o->ec_, iterator );
