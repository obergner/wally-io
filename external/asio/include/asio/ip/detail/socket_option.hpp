            ...
            namespace socket_option
            {
                ...
                class multicast_request
                {
                   public:
                          ...
                          ipv6_value_( )   // Zero-initialisation gives the "any" address.
                    {
                        ...
                        {
                            ipv4_value_.imr_multiaddr.s_addr = asio::detail::socket_ops::host_to_network_long(
                                multicast_address.to_v4( ).to_ulong( ) );
                            ipv4_value_.imr_interface.s_addr = asio::detail::socket_ops::host_to_network_long(
                        ...
                        : ipv6_value_( )  // Zero-initialisation gives the "any" address.
                    {
                        ipv4_value_.imr_multiaddr.s_addr =
                            asio::detail::socket_ops::host_to_network_long( multicast_address.to_ulong( ) );
                        ipv4_value_.imr_interface.s_addr =
                            asio::detail::socket_ops::host_to_network_long( network_interface.to_ulong( ) );
                    }
                ...
                class network_interface
                {
                   public:
                    ...
                    {
                        ipv4_value_.s_addr =
                            asio::detail::socket_ops::host_to_network_long( asio::ip::address_v4::any( ).to_ulong( ) );
                        ipv6_value_ = 0;
                    }
                    ...
                    {
                        ipv4_value_.s_addr =
                            asio::detail::socket_ops::host_to_network_long( ipv4_interface.to_ulong( ) );
                        ipv6_value_ = 0;
                    }
