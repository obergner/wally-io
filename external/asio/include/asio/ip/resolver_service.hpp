...
#endif
        {
...
#if defined( ASIO_WINDOWS_RUNTIME )
            typedef asio::detail::winrt_resolver_service<InternetProtocol> service_impl_type;
#else
           ...
           public:
            ...
            explicit resolver_service( asio::io_service& io_service )
                : asio::detail::service_base<resolver_service<InternetProtocol>>( io_service ),
            ...
            ASIO_INITFN_RESULT_TYPE( ResolveHandler, void( asio::error_code, iterator_type ) )
            async_resolve( implementation_type& impl, const query_type& query, ASIO_MOVE_ARG( ResolveHandler ) handler )
            {
                asio::detail::async_result_init<ResolveHandler, void( asio::error_code, iterator_type )> init(
