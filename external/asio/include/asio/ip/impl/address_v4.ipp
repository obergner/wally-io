...
namespace asio
{
    namespace ip
    {
        ...
        address_v4::address_v4( unsigned long addr )
        {
            ...
            addr_.s_addr =
                asio::detail::socket_ops::host_to_network_long( static_cast<asio::detail::u_long_type>( addr ) );
        }
        ...
        std::string address_v4::to_string( asio::error_code& ec ) const
        {
            ...
            const char* addr = asio::detail::socket_ops::inet_ntop( ASIO_OS_DEF( AF_INET ), &addr_, addr_str,
        ...
        address_v4 address_v4::from_string( const char* str, asio::error_code& ec )
        {
            address_v4 tmp;
            if ( asio::detail::socket_ops::inet_pton( ASIO_OS_DEF( AF_INET ), str, &tmp.addr_, 0, ec ) <= 0 )
                return address_v4( );
            return tmp;
        }
        ...
        address_v4 address_v4::from_string( const std::string& str, asio::error_code& ec )
        {
