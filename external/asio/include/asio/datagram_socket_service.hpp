...
#endif
    {
       ...
       public:
        ...
        explicit datagram_socket_service( asio::io_service& io_service )
            : asio::detail::service_base<datagram_socket_service<Protocol>>( io_service ), service_impl_( io_service )
        {
        }
                       ...
                       ASIO_MOVE_ARG( WriteHandler ) handler )
        {
            ...
            service_impl_.async_send_to( impl, buffers, destination, flags, init.handler );
        ...
        std::size_t receive_from( implementation_type& impl,
                                  ...
                                  asio::error_code& ec )
        {
            return service_impl_.receive_from( impl, buffers, sender_endpoint, flags, ec );
        }
                            ...
                            ASIO_MOVE_ARG( ReadHandler ) handler )
        {
            ...
            service_impl_.async_receive_from( impl, buffers, sender_endpoint, flags, init.handler );
