...
namespace io_wally::protocol
{
    ...
    struct connect_flags final
    {
       public:
        ...
        [[nodiscard]] auto has_username( ) const -> bool
        {
        ...
        [[nodiscard]] auto retain_last_will( ) const -> bool
        {
        ...
        ///
        /// \see packet::QoS
        [[nodiscard]] auto last_will_qos( ) const -> packet::QoS
        {
        ...
        [[nodiscard]] auto contains_last_will( ) const -> bool
        {
        ...
        ///         SHOULD
        [[nodiscard]] auto clean_session( ) const -> bool
        {
    ...
    struct connect final : public mqtt_packet
    {
       public:
        ...
        [[nodiscard]] auto protocol_name( ) const -> const std::string
        {
            return prot_name_;
        }
        ...
        [[nodiscard]] auto protocol_level( ) const -> packet::ProtocolLevel
        {
            switch ( prot_level_ )
            {
                case 0x04:
        ...
        [[nodiscard]] auto keep_alive_secs( ) const -> uint16_t
        {
        ...
        [[nodiscard]] auto will_topic( ) const -> const std::optional<const std::string>&
        {
            return will_topic_;
        }
        ...
        [[nodiscard]] auto will_message( ) const -> const std::optional<const std::vector<uint8_t>>&
        {
        ...
        [[nodiscard]] auto username( ) const -> const std::optional<const std::string>&
        {
            return username_;
        }
        ...
        [[nodiscard]] auto password( ) const -> const std::optional<const std::string>&
        {
            return password_;
        }
        ...
        [[nodiscard]] auto to_string( ) const -> const std::string override
        {
            ...
            output << "connect[cltid:" << client_id_ << "|lwt_ret:" << retain_last_will( )
                   ...
                   << "|keep_alive:" << keep_alive_secs( ) << "|lwt_top:" << ( will_topic_ ? *will_topic_ : "[NULL]" )
