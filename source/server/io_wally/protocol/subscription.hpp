        ...
        struct subscription final
        {
           public:
            ...
            subscription( std::string topic_filter, packet::QoS maximum_qos )
                : topic_filter_{std::move( topic_filter )}, maximum_qos_{std::move( maximum_qos )}
            {
            ...
            inline packet::QoS maximum_qos( ) const
            {
                return maximum_qos_;
            }
            ...
            inline friend std::ostream& operator<<( std::ostream& output, subscription const& subscription )
            {
