...
namespace io_wally::protocol
{
    ...
    {
       public:  // static
        static auto create( const bool dup,
                            const packet::QoS qos,
                            const bool retain,
                            const std::string& topic,
                            const uint16_t packet_identifier,
                            std::vector<uint8_t> application_message ) -> std::unique_ptr<publish>
        {
            ...
            auto remaining_length = qos == packet::QoS::AT_MOST_ONCE ? uint16_t{0} : uint32_t{2};  // packet_identifier
       ...
       public:
        ...
        [[nodiscard]] auto qos( ) const -> packet::QoS
        {
        ...
        [[nodiscard]] auto retain( ) const -> bool
        {
        ...
        ///         0)
        [[nodiscard]] auto has_packet_identifier( ) const -> bool
        {
        ...
        [[nodiscard]] auto application_message( ) const -> const std::vector<uint8_t>&
        {
        ...
        [[nodiscard]] auto with_new_packet_identifier( const std::uint16_t new_packet_identifier ) const
            -> std::shared_ptr<publish>
        {
