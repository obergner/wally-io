...
namespace io_wally::concurrency
{
       ...
       public:
        ...
        void run( )
        {
            ...
            for ( std::size_t i = 0; i < pool_size_; ++i )
            {
                ...
                const auto th = std::make_shared<std::thread>( std::bind(
                    static_cast<std::size_t ( asio::io_service::* )( )>( &asio::io_service::run ), io_services_[i] ) );
