        ...
        namespace encoder
        {
            ...
            class remaining_length_encoder
            {
               public:
                ...
                /// io_wally::protocol::encoder::error::illegal_mqtt_packet if \c remaining_length is greater than the
                ...
                ///                             supplied buffer
                /// \throws io_wally::protocol::encoder::error::illegal_mqtt_packet If \c remaining_length is greater
