...
namespace io_wally
{
    namespace dispatch
    {
        ...
        dispatcher::ptr dispatcher::create( mqtt_connection_handle::packetq_t& dispatchq )
        {
            return std::make_shared<dispatcher>( dispatchq );
        }

        dispatcher::dispatcher( mqtt_connection_handle::packetq_t& dispatchq ) : dispatchq_{dispatchq}
        {
        }
        ...
        void dispatcher::do_receive_packet( )
        {
            ...
            packet_receiver_.async_deq( strand_.wrap( [self](
                const boost::system::error_code& ec, mqtt_connection_handle::packet_container_t::ptr packet_container )
                                                      {
        ...
        void dispatcher::handle_packet_received( const boost::system::error_code& ec,
                                                 mqtt_connection_handle::packet_container_t::ptr packet_container )
        {
            if ( ec )
            {
