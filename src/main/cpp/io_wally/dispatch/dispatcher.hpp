    ...
    namespace dispatch
    {
        ...
        class dispatcher final : public std::enable_shared_from_this<dispatcher>
        {
           public:  // static
            ...
            static dispatcher::ptr create( mqtt_connection_handle::packetq_t& dispatchq );
           ...
           public:
            ...
            ///
            /// \param dispatchq Queue to receive dispatched MQTT packets from
            dispatcher( mqtt_connection_handle::packetq_t& dispatchq );
           ...
           private:
            ...
            boost::asio::queue_listener<mqtt_connection_handle::packetq_t> packet_receiver_{io_service_, &dispatchq_};
