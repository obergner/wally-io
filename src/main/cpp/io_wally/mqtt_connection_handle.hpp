...
namespace io_wally
{
    ...
    class mqtt_connection_handle
    {
       public:  // static
        /// Shared pointer
        using ptr = std::shared_ptr<mqtt_connection_handle>;

        /// A container for protocol packets
        using packet_container_t = dispatch::packet_container<mqtt_connection_handle>;
       ...
       public:
        ...
        inline friend std::ostream& operator<<( std::ostream& output, mqtt_connection_handle const& mqtt_connection )
        {
