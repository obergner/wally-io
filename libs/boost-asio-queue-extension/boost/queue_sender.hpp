...
namespace boost
{
    namespace asio
    {
        ...
        template <typename Impl = queue_sender_impl>
        class basic_queue_sender_service;
        ...
        using queue_sender = basic_queue_sender<basic_queue_sender_service<>, Queue>;
        ...
        class basic_queue_sender_service : public boost::asio::io_service::service
        {
           public:
            ...
            template <typename Handler, typename Queue>
            void timed_async_enq( implementation_type& impl,
                                  Queue* q,
        ...
        class queue_sender_impl
        {
           ...
           public:
            ...
            template <typename Handler, typename Queue>
            void async_enq( std::shared_ptr<queue_sender_impl> impl,
                            Queue* q,
                            typename Queue::value_type val,
                            Handler handler )
            {
            ...
            template <typename Handler, typename Queue>
            void timed_async_enq( std::shared_ptr<queue_sender_impl> impl,
                                  Queue* q,
                                  typename Queue::value_type val,
                                  Handler handler,
                                  std::size_t ms )
            ...
            template <typename Handler, typename Queue>
            void timed_async_wait_enq( std::shared_ptr<queue_sender_impl> impl,
                                       Queue* q,
                                       Handler handler,
                                       std::size_t ms )
            {
