    ...
    namespace ip
    {
        ...
        class address_v6
        {
           public:
            ...
            /// Create an address from an IP address string.
            ASIO_DECL static address_v6 from_string( const char* str, asio::error_code& ec );

            /// Create an address from an IP address string.
            ASIO_DECL static address_v6 from_string( const std::string& str );

            /// Create an address from an IP address string.
            ASIO_DECL static address_v6 from_string( const std::string& str, asio::error_code& ec );
