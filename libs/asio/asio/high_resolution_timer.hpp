...
#if defined( ASIO_HAS_STD_CHRONO ) || defined( ASIO_HAS_BOOST_CHRONO ) || defined( GENERATING_DOCUMENTATION )
...
#elif defined( ASIO_HAS_BOOST_CHRONO )
    typedef basic_waitable_timer<boost::chrono::high_resolution_clock> high_resolution_timer;
#endif
