...
namespace asio
{
    namespace posix
    {
        ...
        class basic_descriptor : public basic_io_object<DescriptorService>, public descriptor_base
        {
           public:
             ...
             * descriptor.
             */
            explicit basic_descriptor( asio::io_service& io_service ) : basic_io_object<DescriptorService>( io_service )
            {
            }
             ...
             */
            basic_descriptor( asio::io_service& io_service, const native_handle_type& native_descriptor )
                : basic_io_object<DescriptorService>( io_service )
            {
                asio::error_code ec;
                this->get_service( ).assign( this->get_implementation( ), native_descriptor, ec );
            ...
            basic_descriptor( basic_descriptor&& other )
                : basic_io_object<DescriptorService>( ASIO_MOVE_CAST( basic_descriptor )( other ) )
            {
            }
            ...
            {
                basic_io_object<DescriptorService>::operator=( ASIO_MOVE_CAST( basic_descriptor )( other ) );
                return *this;
            }
             ...
             */
            asio::error_code assign( const native_handle_type& native_descriptor, asio::error_code& ec )
            {
                return this->get_service( ).assign( this->get_implementation( ), native_descriptor, ec );
            }
