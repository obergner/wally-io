    ...
    namespace posix
    {
        ...
        class basic_stream_descriptor : public basic_descriptor<StreamDescriptorService>
        {
           public:
             ...
             */
            basic_stream_descriptor( asio::io_service& io_service, const native_handle_type& native_descriptor )
            ...
            basic_stream_descriptor( basic_stream_descriptor&& other )
                : basic_descriptor<StreamDescriptorService>( ASIO_MOVE_CAST( basic_stream_descriptor )( other ) )
            {
            }
