...
namespace asio
{
    ...
    class io_service::id : private noncopyable
    {
       public:
        /// Constructor.
        id( )
    ...
    class io_service::service : private noncopyable
    {
       public:
       ...
       private:
         ...
         */
        ASIO_DECL virtual void fork_service( asio::io_service::fork_event event );
    ...
    namespace detail
    {
        ...
        class service_base : public asio::io_service::service
        {
           public:
            ...
            // Constructor.
            service_base( asio::io_service& io_service ) : asio::io_service::service( io_service )
            {
            }
        };
