...
namespace asio
{
    namespace detail
    {
        ...
        win_iocp_serial_port_service::win_iocp_serial_port_service( asio::io_service& io_service )
        ...
        asio::error_code win_iocp_serial_port_service::open( win_iocp_serial_port_service::implementation_type& impl,
                                                             ...
                                                             asio::error_code& ec )
        {
            ...
            ::HANDLE handle = ::CreateFileA( name.c_str( ), GENERIC_READ | GENERIC_WRITE, 0, 0, OPEN_EXISTING,
