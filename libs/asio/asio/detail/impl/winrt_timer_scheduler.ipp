...
namespace asio
{
    namespace detail
    {
        ...
        winrt_timer_scheduler::winrt_timer_scheduler( asio::io_service& io_service )
            : asio::detail::service_base<winrt_timer_scheduler>( io_service ),
              ...
              shutdown_( false )
        {
            thread_ = new asio::detail::thread( bind_handler( &winrt_timer_scheduler::call_run_thread, this ) );
        }
