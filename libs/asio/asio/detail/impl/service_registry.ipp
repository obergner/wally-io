...
namespace asio
{
    namespace detail
    {
        ...
        void service_registry::init_key( asio::io_service::service::key& key, const asio::io_service::id& id )
        {
            key.type_info_ = 0;
            key.id_ = &id;
        }

        bool service_registry::keys_match( const asio::io_service::service::key& key1,
        ...
        asio::io_service::service* service_registry::do_use_service( const asio::io_service::service::key& key,
        ...
        void service_registry::do_add_service( const asio::io_service::service::key& key,
        ...
        bool service_registry::do_has_service( const asio::io_service::service::key& key ) const
        {
            asio::detail::mutex::scoped_lock lock( mutex_ );
