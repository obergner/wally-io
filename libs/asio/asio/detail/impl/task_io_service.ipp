    ...
    namespace detail
    {
        ...
        struct task_io_service::task_cleanup
        {
            ~task_cleanup( )
            {
                ...
                {
                    asio::detail::increment( task_io_service_->outstanding_work_,
        ...
        task_io_service::task_io_service( asio::io_service& io_service, std::size_t concurrency_hint )
        ...
        void task_io_service::post_immediate_completion( task_io_service::operation* op, bool is_continuation )
        {
#if defined( ASIO_HAS_THREADS )
        ...
        void task_io_service::post_deferred_completions( op_queue<task_io_service::operation>& ops )
        {
            if ( !ops.empty( ) )
            {
#if defined( ASIO_HAS_THREADS )
        ...
        void task_io_service::do_dispatch( task_io_service::operation* op )
        {
            work_started( );
            mutex::scoped_lock lock( mutex_ );
            op_queue_.push( op );
        ...
        void task_io_service::abandon_operations( op_queue<task_io_service::operation>& ops )
        {
        ...
        void task_io_service::stop_all_threads( mutex::scoped_lock& lock )
        {
            stopped_ = true;
