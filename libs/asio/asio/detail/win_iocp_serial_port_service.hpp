        ...
        class win_iocp_serial_port_service
        {
           public:
            ...
            asio::error_code set_option( implementation_type& impl,
                                         ...
                                         asio::error_code& ec )
            {
                return do_set_option( impl, &win_iocp_serial_port_service::store_option<SettableSerialPortOption>,
                                      &option, ec );
            }
            ...
            {
                return do_get_option( impl, &win_iocp_serial_port_service::load_option<GettableSerialPortOption>,
                                      &option, ec );
            }
           ...
           private:
            ...
            {
                return static_cast<const SettableSerialPortOption*>( option )->store( storage, ec );
            }
