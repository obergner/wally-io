...
namespace asio
{
    namespace detail
    {
        ...
        auto one_arg_handler_test( Handler h, Arg1* a1 )
            -> decltype( sizeof( Handler( static_cast<const Handler&>( h ) ) ), ( ( h )( *a1 ) ), char( 0 ) );
        ...
        auto two_arg_handler_test( Handler h, Arg1* a1, Arg2* a2 )
            -> decltype( sizeof( Handler( static_cast<const Handler&>( h ) ) ), ( ( h )( *a1, *a2 ) ), char( 0 ) );
...
#define ASIO_COMPLETION_HANDLER_CHECK( handler_type, handler )                                                    \
    ...
    ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT(                                                                        \
        sizeof( asio::detail::zero_arg_handler_test( asio::detail::clvref<asio_true_handler_type>( ), 0 ) ) == 1, \
...
#define ASIO_READ_HANDLER_CHECK( handler_type, handler )                                                        \
    ...
    typedef ASIO_HANDLER_TYPE( handler_type, void( asio::error_code, std::size_t ) ) asio_true_handler_type;    \
                                                                                                                \
    ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT(                                                                      \
        sizeof( asio::detail::two_arg_handler_test( asio::detail::clvref<asio_true_handler_type>( ),            \
    ...
    typedef asio::detail::handler_type_requirements<                                                            \
        sizeof( asio::detail::argbyv( asio::detail::clvref<asio_true_handler_type>( ) ) ) +                     \
        sizeof( asio::detail::lvref<asio_true_handler_type>( )( asio::detail::lvref<const asio::error_code>( ), \
...
#define ASIO_ACCEPT_HANDLER_CHECK( handler_type, handler )                                                        \
    ...
    typedef ASIO_HANDLER_TYPE( handler_type, void( asio::error_code ) ) asio_true_handler_type;                   \
                                                                                                                  \
    ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT(                                                                        \
        sizeof( asio::detail::one_arg_handler_test( asio::detail::clvref<asio_true_handler_type>( ),              \
