    ...
    namespace windows
    {
        ...
        class basic_object_handle : public basic_handle<ObjectHandleService>
        {
           public:
             ...
             */
            basic_object_handle( asio::io_service& io_service, const native_handle_type& native_handle )
            ...
            basic_object_handle( basic_object_handle&& other )
                : basic_handle<ObjectHandleService>( ASIO_MOVE_CAST( basic_object_handle )( other ) )
            {
            }
            ...
            {
                basic_handle<ObjectHandleService>::operator=( ASIO_MOVE_CAST( basic_object_handle )( other ) );
                return *this;
            }
