...
namespace asio
{
    namespace ssl
    {
        ...
        template <typename VerifyCallback>
        asio::error_code context::set_verify_callback( VerifyCallback callback, asio::error_code& ec )
        {
            return do_set_verify_callback( new detail::verify_callback<VerifyCallback>( callback ), ec );
        }
        ...
        template <typename PasswordCallback>
        asio::error_code context::set_password_callback( PasswordCallback callback, asio::error_code& ec )
        {
            return do_set_password_callback( new detail::password_callback<PasswordCallback>( callback ), ec );
        }
