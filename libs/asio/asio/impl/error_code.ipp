        ...
        class system_category : public error_category
        {
           public:
            ...
            std::string message( int value ) const
            {
                ...
                {
                    DWORD wlength =
                        ::FormatMessageW( FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS, 0, value,
                    ...
                    if ( wlength )
                    {
                        ...
                        int length = ::WideCharToMultiByte( CP_ACP, 0, wmsg.c_str( ), static_cast<int>( wlength ),
                ...
                DWORD length = ::FormatMessageA(
                    FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS, 0,
                    value, MAKELANGID( LANG_NEUTRAL, SUBLANG_DEFAULT ), (char*)&msg, 0, 0 );
