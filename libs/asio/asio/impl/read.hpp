...
namespace asio
{
    ...
    namespace detail
    {
        ...
        class read_op<AsyncReadStream, asio::mutable_buffers_1, CompletionCondition, ReadHandler>
            ...
            void operator( )( const asio::error_code& ec, std::size_t bytes_transferred, int start = 0 )
            {
                ...
                switch ( start_ = start )
                {
                    case 1:
                        ...
                        for ( ;; )
                        {
                            stream_.async_read_some( asio::buffer( buffer_ + total_transferred_, n ),
        ...
        class read_op<AsyncReadStream, boost::array<Elem, 2>, CompletionCondition, ReadHandler>
            : detail::base_from_completion_cond<CompletionCondition>
        {
           public:
            read_op( AsyncReadStream& stream,
        ...
        template <typename AsyncReadStream, typename Elem, typename CompletionCondition, typename ReadHandler>
        class read_op<AsyncReadStream, std::array<Elem, 2>, CompletionCondition, ReadHandler>
            : detail::base_from_completion_cond<CompletionCondition>
        {
           public:
            read_op( AsyncReadStream& stream,
                    ...
                    ASIO_MOVE_ARG( ReadHandler ) handler )
    {
        ...
        detail::read_op<AsyncReadStream, MutableBufferSequence, CompletionCondition,
    ...
    inline ASIO_INITFN_RESULT_TYPE( ReadHandler, void( asio::error_code, std::size_t ) )
        async_read( AsyncReadStream& s, const MutableBufferSequence& buffers, ASIO_MOVE_ARG( ReadHandler ) handler )
    {
        // If you get an error on the following line it means that your handler does
        // not meet the documented type requirements for a ReadHandler.
        ASIO_READ_HANDLER_CHECK( ReadHandler, handler ) type_check;
        ...
        detail::read_op<AsyncReadStream, MutableBufferSequence, detail::transfer_all_t,
                        ASIO_HANDLER_TYPE( ReadHandler, void( asio::error_code, std::size_t ) )>(
    ...
    namespace detail
    {
        ...
        class read_streambuf_op : detail::base_from_completion_cond<CompletionCondition>
        {
           public:
        ...
        inline void* asio_handler_allocate(
            std::size_t size,
            read_streambuf_op<AsyncReadStream, Allocator, CompletionCondition, ReadHandler>* this_handler )
        {
            return asio_handler_alloc_helpers::allocate( size, this_handler->handler_ );
        }
                    ...
                    ASIO_MOVE_ARG( ReadHandler ) handler )
    {
        ...
        detail::read_streambuf_op<AsyncReadStream, Allocator, CompletionCondition,
                                  ASIO_HANDLER_TYPE( ReadHandler, void( asio::error_code, std::size_t ) )>(
            s, b, completion_condition, init.handler )( asio::error_code( ), 0, 1 );
    ...
    inline ASIO_INITFN_RESULT_TYPE( ReadHandler, void( asio::error_code, std::size_t ) )
        async_read( AsyncReadStream& s, asio::basic_streambuf<Allocator>& b, ASIO_MOVE_ARG( ReadHandler ) handler )
    {
        // If you get an error on the following line it means that your handler does
        // not meet the documented type requirements for a ReadHandler.
        ASIO_READ_HANDLER_CHECK( ReadHandler, handler ) type_check;
        ...
        detail::read_streambuf_op<AsyncReadStream, Allocator, detail::transfer_all_t,
                                  ASIO_HANDLER_TYPE( ReadHandler, void( asio::error_code, std::size_t ) )>(
            s, b, transfer_all( ), init.handler )( asio::error_code( ), 0, 1 );
