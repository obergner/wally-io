    ...
    class basic_stream_socket : public basic_socket<Protocol, StreamSocketService>
    {
       public:
        ...
        basic_stream_socket( asio::io_service& io_service,
            ...
            : basic_socket<Protocol, StreamSocketService>( io_service, protocol, native_socket )
        {
        }
        ...
        basic_stream_socket( basic_stream_socket&& other )
            : basic_socket<Protocol, StreamSocketService>( ASIO_MOVE_CAST( basic_stream_socket )( other ) )
        {
        }
        ...
        {
            basic_socket<Protocol, StreamSocketService>::operator=( ASIO_MOVE_CAST( basic_stream_socket )( other ) );
            return *this;
        }
        ...
        basic_stream_socket( basic_stream_socket<Protocol1, StreamSocketService1>&& other,
                             typename enable_if<is_convertible<Protocol1, Protocol>::value>::type* = 0 )
            : basic_socket<Protocol, StreamSocketService>(
                  ASIO_MOVE_CAST2( basic_stream_socket<Protocol1, StreamSocketService1> )( other ) )
        {
        }
         ...
         */
        template <typename Protocol1, typename StreamSocketService1>
        typename enable_if<is_convertible<Protocol1, Protocol>::value, basic_stream_socket>::type& operator=(
        ...
        {
            return this->get_service( ).receive( this->get_implementation( ), buffers, 0, ec );
        }
