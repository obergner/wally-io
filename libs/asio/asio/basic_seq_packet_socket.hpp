...
namespace asio
{
    ...
    class basic_seq_packet_socket : public basic_socket<Protocol, SeqPacketSocketService>
    {
       public:
        ...
        typedef typename SeqPacketSocketService::native_handle_type native_handle_type;
        ...
        basic_seq_packet_socket( asio::io_service& io_service,
            ...
            : basic_socket<Protocol, SeqPacketSocketService>( io_service, protocol, native_socket )
        {
        }
        ...
        basic_seq_packet_socket( basic_seq_packet_socket&& other )
            : basic_socket<Protocol, SeqPacketSocketService>( ASIO_MOVE_CAST( basic_seq_packet_socket )( other ) )
        {
        }
        ...
        basic_seq_packet_socket( basic_seq_packet_socket<Protocol1, SeqPacketSocketService1>&& other,
                                 typename enable_if<is_convertible<Protocol1, Protocol>::value>::type* = 0 )
            : basic_socket<Protocol, SeqPacketSocketService>(
                  ASIO_MOVE_CAST2( basic_seq_packet_socket<Protocol1, SeqPacketSocketService1> )( other ) )
        {
        }
         ...
         */
        template <typename Protocol1, typename SeqPacketSocketService1>
        typename enable_if<is_convertible<Protocol1, Protocol>::value, basic_seq_packet_socket>::type& operator=(
        ...
        {
            asio::error_code ec;
            std::size_t s = this->get_service( ).receive( this->get_implementation( ), buffers, 0, out_flags, ec );
                             ...
                             socket_base::message_flags& out_flags )
        {
            asio::error_code ec;
            std::size_t s =
                this->get_service( ).receive( this->get_implementation( ), buffers, in_flags, out_flags, ec );
            asio::detail::throw_error( ec, "receive" );
            return s;
        }
        ...
        std::size_t receive( const MutableBufferSequence& buffers,
                             ...
                             asio::error_code& ec )
        {
            return this->get_service( ).receive( this->get_implementation( ), buffers, in_flags, out_flags, ec );
        }
                       ...
                       ASIO_MOVE_ARG( ReadHandler ) handler )
        {
            ...
            return this->get_service( ).async_receive( this->get_implementation( ), buffers, 0, out_flags,
                       ...
                       ASIO_MOVE_ARG( ReadHandler ) handler )
        {
            ...
            return this->get_service( ).async_receive( this->get_implementation( ), buffers, in_flags, out_flags,
                                                       ASIO_MOVE_CAST( ReadHandler )( handler ) );
        }
    };
