...
namespace asio
{
    ...
    class basic_signal_set : public basic_io_object<SignalSetService>
    {
       public:
         ...
         */
        explicit basic_signal_set( asio::io_service& io_service ) : basic_io_object<SignalSetService>( io_service )
        {
        }
        ...
        async_wait( ASIO_MOVE_ARG( SignalHandler ) handler )
        {
            ...
            return this->service.async_wait( this->implementation, ASIO_MOVE_CAST( SignalHandler )( handler ) );
        }
    };
