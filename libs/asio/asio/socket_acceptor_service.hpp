...
#endif
    {
       ...
       public:
        ...
        explicit socket_acceptor_service( asio::io_service& io_service )
            : asio::detail::service_base<socket_acceptor_service<Protocol>>( io_service ), service_impl_( io_service )
        {
        }
        ...
        async_accept( implementation_type& impl,
                      ...
                      typename enable_if<is_convertible<Protocol, Protocol1>::value>::type* = 0 )
        {
            detail::async_result_init<AcceptHandler, void( asio::error_code )> init(
