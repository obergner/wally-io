    ...
    class io_service::strand
    {
       public:
        ...
        explicit strand( asio::io_service& io_service )
            : service_( asio::use_service<asio::detail::strand_service>( io_service ) )
        {
        ...
        dispatch( ASIO_MOVE_ARG( CompletionHandler ) handler )
        {
            ...
            detail::async_result_init<CompletionHandler, void( )> init(
        ...
        {
            return detail::wrapped_handler<io_service::strand, Handler, detail::is_continuation_if_running>( *this,
                                                                                                             handler );
        }
