    ...
    class basic_socket_acceptor : public basic_io_object<SocketAcceptorService>, public socket_base
    {
       public:
            ...
            : basic_io_object<SocketAcceptorService>( io_service )
        {
            ...
            this->get_service( ).listen( this->get_implementation( ), socket_base::max_connections, ec );
        ...
        basic_socket_acceptor( basic_socket_acceptor&& other )
            : basic_io_object<SocketAcceptorService>( ASIO_MOVE_CAST( basic_socket_acceptor )( other ) )
        {
        }
        ...
        {
            basic_io_object<SocketAcceptorService>::operator=( ASIO_MOVE_CAST( basic_socket_acceptor )( other ) );
            return *this;
        }
         ...
         */
        template <typename Protocol1, typename SocketAcceptorService1>
        basic_socket_acceptor( basic_socket_acceptor<Protocol1, SocketAcceptorService1>&& other,
         ...
         */
        template <typename Protocol1, typename SocketAcceptorService1>
        typename enable_if<is_convertible<Protocol1, Protocol>::value, basic_socket_acceptor>::type& operator=(
            basic_socket_acceptor<Protocol1, SocketAcceptorService1>&& other )
        {
            basic_socket_acceptor tmp(
                ASIO_MOVE_CAST2( basic_socket_acceptor<Protocol1, SocketAcceptorService1> )( other ) );
            basic_io_object<SocketAcceptorService>::operator=( ASIO_MOVE_CAST( basic_socket_acceptor )( tmp ) );
            return *this;
        }
        ...
        asio::error_code assign( const protocol_type& protocol,
                                 ...
                                 asio::error_code& ec )
        {
            return this->get_service( ).assign( this->get_implementation( ), protocol, native_acceptor, ec );
        }
        ...
        {
            asio::error_code ec;
            this->get_service( ).accept( this->get_implementation( ), peer, static_cast<endpoint_type*>( 0 ), ec );
         ...
         */
        template <typename Protocol1, typename SocketService>
        asio::error_code accept( basic_socket<Protocol1, SocketService>& peer,
                                 asio::error_code& ec,
                                 typename enable_if<is_convertible<Protocol, Protocol1>::value>::type* = 0 )
        {
            return this->get_service( ).accept( this->get_implementation( ), peer, static_cast<endpoint_type*>( 0 ),
                                                ec );
        }
        ...
        {
            asio::error_code ec;
            this->get_service( ).accept( this->get_implementation( ), peer, &peer_endpoint, ec );
            asio::detail::throw_error( ec, "accept" );
        }
         ...
         */
        template <typename SocketService>
        asio::error_code accept( basic_socket<protocol_type, SocketService>& peer,
                                 endpoint_type& peer_endpoint,
                                 asio::error_code& ec )
        {
            return this->get_service( ).accept( this->get_implementation( ), peer, &peer_endpoint, ec );
        }
                      ...
                      ASIO_MOVE_ARG( AcceptHandler ) handler )
        {
            ...
            return this->get_service( ).async_accept( this->get_implementation( ), peer, &peer_endpoint,
                                                      ASIO_MOVE_CAST( AcceptHandler )( handler ) );
        }
    };
